...
open class GameObject {
    ...
    init(name: String = "Unnamed GameObject", position: Float3 = [0, 0, 0]) {
        self.name = name
...
public class Cube: GameObject, Primitive {
    public override init(name: String = "Cube", position: Float3 = [0, 0, 0]) {
...
public class Sphere: GameObject, Primitive {
    public override init(name: String = "Sphere", position: Float3 = [0, 0, 0]) {
        super.init(name: name, position: position)
...
public class Plane: GameObject, Primitive {
    public override init(name: String = "Plane", position: Float3 = [0, 0, 0]) {
        super.init(name: name, position: position)
